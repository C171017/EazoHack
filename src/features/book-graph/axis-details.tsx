...
export function AxisDetails({detail,onSource,onLocate}:{detail:NodeDetail;onSource:(anchor:SourceAnchor)=>void;onLocate:(id:string)=>void}) {
  ...
  return <details className="map-axis-evidence"><summary>Why this position?</summary>
    ...
    <p>Source-grounded model interpretation. The scale is ordered; equal numeric differences need not mean equal differences in meaning.</p>
  </details>;
}
