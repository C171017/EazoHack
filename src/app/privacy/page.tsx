...
export default function PrivacyPage() {
  return <main style={{ maxWidth: 720, margin: '0 auto', padding: '64px 24px', lineHeight: 1.7 }}>
    ...
    <h2>What is saved</h2>
    <p>Your cloud library stores books you choose to import, extracted source text, reading positions, highlights, generated reading aids (including images and interactive state), and heatmap activity. It also stores source identifiers and generated analysis linked to those books. These records belong to your account. Other Eazo users cannot access them through the library.</p>
    <p>Your shelf includes default books, this browser’s local books, and your account books while signed in. New uploads while signed in save to your account unless you choose “Keep on this device only.” Reading the default books while signed in also saves your reading to your account. Signing in does not automatically import existing guest reading. You choose whether to copy this device’s guest books and progress into your account. Cloud changes synchronize while signed in and online. An offline device keeps its pending changes locally.</p>
    ...
    <p>The initial cloud allowance is 100 books, 500 source versions, 100 MiB of source files per account, 50 MiB per source file, and 100 MiB of saved reading history, and 100 MiB of private reading illustrations. Generated analysis has separate usage controls. Eazo shows an error if a save exceeds its allowance, and keeps the unsaved work locally.</p>
