...
function state() {
  return {
    ...
    defaults: { text: process.env.GEMINI_MODEL || 'gemini-3.8-flash', vertex: process.env.GEMINI_MODEL || 'gemini-3.8-flash', image: process.env.IMAGE_PROVIDER === 'bfl' ? 'FLUX.2 [klein] 9B' : 'Z-Image Turbo' },
