...
1. Create 3-7 distinct overarching theme territories, with a stable display order. Explain each theme using the evidence. Topics provide colors and metadata; their order is NOT an X coordinate. Assign EVERY node ID to exactly ONE primary theme. Prefer themes spanning multiple chunks. Topic order does not imply semantic distance.
